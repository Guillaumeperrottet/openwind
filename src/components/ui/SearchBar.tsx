    ...
    <div ref={ref} className="relative flex-1">
      <div className="relative">
        ...
        <input
          ...
          autoFocus={autoFocus}
          className="w-full rounded-full bg-gray-100 border border-gray-200 pl-9 pr-8 py-2 text-sm text-gray-900 placeholder:text-gray-400 focus:ring-2 focus:ring-sky-500 focus:border-sky-500 focus:bg-white outline-none transition-all"
        />
        {query && (
          <button
            onClick={() => {
