...
export default function HomeLoading() {
  ...
  return (
    ...
    >
      {/* Fake map controls top-left */}
      <div className="absolute top-4 left-4 z-10 flex flex-col gap-1.5">
        <div className="h-8 w-28 rounded-full bg-white/80 shadow" />
        <div className="h-7 w-36 rounded-full bg-white/80 shadow" />
      </div>
      ...
      {/* Fake legend bottom-left */}
      <div className="absolute bottom-6 left-4 z-10">
        <div className="h-8 w-20 rounded-full bg-white/80 shadow" />
      </div>
    </div>
  );
}
